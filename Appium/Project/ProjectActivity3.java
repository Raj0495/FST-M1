...
/*        WebElement daydrpdwn = driver.findElement(AppiumBy
                .accessibilityId("Date - Currently selected - February 4"));

        Select click1 = new Select(daydrpdwn);
        
        click1.selectByVisibleText("Today");

        WebElement noondrpdwn = driver.findElement(AppiumBy
                .xpath("//android.widget.LinearLayout[contains(@resource-id, 'com.google.android.keep:id/time_spinner')]"));

        Select click2 = new Select(noondrpdwn);

        click2.selectByVisibleText("Afternoon");*/
